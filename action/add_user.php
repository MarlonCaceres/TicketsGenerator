<?php	
	...
	if (empty($_POST['name'])) {
		...
		if(isset($_POST["is_admin"])){$is_admin=1;}
			...
			$sql="INSERT INTO user ( name, password, email, profile_pic, is_active, created_at,role,Empresa) VALUES ('$end_name','$password','$email','$profile_pic',1,'$created_at','$rol','$empresa')";
