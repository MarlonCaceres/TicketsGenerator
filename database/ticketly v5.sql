...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-01-2018 a las 15:40:53
...
INSERT INTO `tareas` (`id`, `title`, `description`, `user_id`, `ticket_id`, `company_id`, `status`, `create_date`) VALUES
(3, 'diseÃ±o front', 'diseÃ±o front de braining ', 2, 13, 1, 1, 2018),
(7, 'fsdf', 'asdfasdf', 4, 3, 1, 0, 2018),
(8, 'correccion de errores', 'correccion de errores', 4, 13, 1, 0, 2018),
(9, 'fsdf', 'adsfasd', 4, 13, 1, 0, 2018),
(10, 'cambio muy importante', 'ddd', 4, 19, 1, 1, 2018),
(11, 'crear firma', 'dfdfds', 5, 20, 2, 0, 2018);
...
INSERT INTO `ticket` (`id`, `title`, `description`, `updated_at`, `created_at`, `fecha_entrega`, `kind_id`, `user_id`, `asigned_id`, `project_id`, `category_id`, `empresa_id_asig`, `priority_id`, `status_id`, `adjunto`) VALUES
(2, 'otra prueba', 'asdfda', NULL, '2018-01-03 09:59:18', NULL, 1, 4, NULL, 1, 1, 1, 1, 6, ''),
...
(6, 'insumos graficos para wasihome', 'por favor necesito los grÃ¡ficos para la pagina web ', '2018-01-09 12:39:59', '2018-01-03 15:41:51', '0000-00-00', 1, 4, NULL, 1, 2, 2, 1, 1, 'construccion390.jpg'),
...
(12, 'test', 'test 1', '2018-01-08 13:30:56', '2018-01-04 10:04:16', '2018-01-05', 1, 5, NULL, 1, 3, 1, 4, 2, ''),
(13, 'Pagina web', 'pagina web braining labs', '2018-01-08 13:26:21', '2018-01-04 17:34:30', '2018-01-10', 1, 1, NULL, 4, 4, 1, 2, 4, ''),
(15, 'Cambio de logo para BigbangIdea', 'Es necesario modificar el logo de BigbanIdea', NULL, '2018-01-09 11:21:49', '2018-01-13', 1, 4, NULL, 0, 5, 2, 1, 1, 'log bbi1794.jpg'),
(16, 'adfadsf', 'dsafs', NULL, '2018-01-09 11:25:38', '0000-00-00', 1, 4, NULL, 0, 0, 2, 1, 6, 'construccion36.jpg'),
(17, 'asdfas', 'asdfasd', '2018-01-09 12:43:52', '2018-01-09 11:26:40', '0000-00-00', 1, 4, NULL, 0, 0, 2, 1, 6, 'construccion999.jpg'),
(18, 'otra prueba ', 'sdfsdaf', '2018-01-09 12:40:53', '2018-01-09 11:57:03', '2018-01-11', 1, 4, NULL, 0, 2, 2, 1, 1, 'log bbi925.jpg'),
(19, 'cambios en BigbanIdea', 'se necesita cambiar el logo de la pagina web por el adjunto', '2018-01-09 12:13:45', '2018-01-09 12:13:09', '2018-01-10', 1, 5, NULL, 0, 3, 1, 3, 2, 'log bbi52.jpg'),
(20, 'nueva firma para nuevo compa;ero', 'por favor crear una firma para marlon', NULL, '2018-01-09 12:45:42', '2018-01-09', 1, 4, NULL, 0, 5, 2, 1, 1, 'hola424.txt');
...
--
ALTER TABLE `tareas`
  ADD CONSTRAINT `tareas_ibfk_1` FOREIGN KEY (`ticket_id`) REFERENCES `ticket` (`id`),
  ADD CONSTRAINT `tareas_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`),
  ADD CONSTRAINT `tareas_ibfk_3` FOREIGN KEY (`company_id`) REFERENCES `company` (`id`);
